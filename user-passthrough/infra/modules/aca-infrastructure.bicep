...
@description('Resource ID of the user-assigned managed identity used for OBO')
param userAssignedManagedIdentityId string

@description('Client ID of the user-assigned managed identity used for OBO')
param userAssignedManagedIdentityClientId string

@description('Federated token exchange audience for the target Azure cloud')
...
var baseArgs = [
  ...
  // This would bypass the MCP authorization boundary and is unsafe even though downstream OBO still requires a user assertion.
]
