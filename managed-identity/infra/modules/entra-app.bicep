...
var inspectorRoleValue = 'Mcp.Inspector.Access'
var inspectorRoleId = guid(subscription().id, inspectorRoleValue)
var inspectorRoleDisplayName = 'Azure MCP Inspector Access'
var inspectorRoleDescription = 'User permission for testing Azure MCP through API Management'
...
resource entraApp 'Microsoft.Graph/applications@v1.0' = {
  ...
  appRoles: [
    ...
    {
      id: inspectorRoleId
      displayName: inspectorRoleDisplayName
      description: inspectorRoleDescription
      value: inspectorRoleValue
      isEnabled: true
...
output entraAppRoleId string = entraAppRoleId
output inspectorRoleId string = inspectorRoleId
